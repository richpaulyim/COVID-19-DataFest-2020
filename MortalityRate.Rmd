...
```{r}
ggplot(data = narrowed_march, aes(x = days_since, y = rate)) + 
  geom_line(aes(color = location)) + 
...
```{r}
ggplot(data = narrowed_march, aes(x = days_since, y = new_cases)) + 
  geom_line(aes(color = location)) + 
...
```{r}
ggplot(data = narrowed_march, aes(x = days_since, y = total_cases)) + 
  geom_line(aes(color = location)) + 
